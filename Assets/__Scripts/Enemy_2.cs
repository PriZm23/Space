...
public class Enemy_2 : Enemy
{
    ...
    // Определяют, насколько ярко будет выражен 
    // синусоидальный характер движения
    ...
    {
        // Кривые Безье вычисляются на основе значения u между 0 т 1
        float u = (Time.time - birthTime) / lifeTime;

        // Если u>1, значит корабль существуеь больше чем lifeTime
        if (u > 1)
        {
            // Этот экзкмпляр Enemy_2 завершил свой жизненный цикл
